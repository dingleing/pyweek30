...
menu1 = ["Start", "Reset", "About", "Help", "Quit"]
...
def hub():
    ...
    while menuX:
        ...
        if lines[0] == "intro":
            ...
            menuX, fs = enviroment_level(screen, display, Window_size, fs)
        elif lines[0] == "space_station":
            menuX, fs = alien_level(screen, display, Window_size, fs)
        elif lines[0] == "ending":
            menuX, fs = ending(screen, display, Window_size, fs)
        else:
            menuX = False
            dispmenu()
