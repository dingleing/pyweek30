...
def get_ray_dictionary():
    ...
    blocks = {
        "0": Ray_cast_block(),
        "1": Ray_cast_block(pygame.image.load("assets/textures/enviroment/rock_wall3.png")),
        "2": Ray_cast_block(pygame.image.load("assets/textures/Wall_Dirt.png")),
        "3": Ray_cast_block(),
        ...
        "7": Ray_cast_block(pygame.image.load("assets/textures/enviroment/bush.png")),
        "8": Ray_cast_block(pygame.image.load("assets/textures/speed_up_temporary.png")),
        "9": Ray_cast_block(pygame.image.load("assets/textures/enviroment/rock_wall1.png")),
        "a": Ray_cast_block(pygame.image.load("assets/textures/enviroment/rock_wall2.png"))
        }
