...
def sample_level(screenX):
    ...
    Player = Object("player", game.custom_id_giver, [50, 50], [0, 0], 0.01, True, [5, 5])
    ...
    # dont try to understand the comment above its just 30 it just is
    ...
    while game.alive:
        ...
        rays.cast_rays(120, Player.direction, player_mid,
                       game_map, Player.direction + (Player.move.offset * Player.move.degree))
