...
from alien_level_engine import *
from sounds import *
...
def alien_level(screenX, display, Window_size, fs=False):
    ...
    Player = Object("player", game.custom_id_giver, [100, 5024], [0, 0], 0.01, True, [8, 8])
    Player.move.collisions = True  # enables collisions for player
    Player.move.speed = 10  # increasing speed so ur not super slow
    ...
    game_map = load_map("assets/maps/alien_station")
    ...
    while game.alive:
        ...
        pygame.draw.rect(display, (140, 140, 140), (0, 330, 600, 120))
        pygame.draw.rect(display, (120, 120, 120), (0, 275, 600, 80))
        pygame.draw.rect(display, (100, 100, 100), (0, 245, 600, 30))
        pygame.draw.rect(display, (80, 80, 80), (0, 225, 600, 20))

        # celling

        pygame.draw.rect(display, (140, 140, 140), (0, -25, 600, 120))
        pygame.draw.rect(display, (120, 120, 120), (0, 95, 600, 80))
        pygame.draw.rect(display, (100, 100, 100), (0, 175, 600, 30))
        pygame.draw.rect(display, (80, 80, 80), (0, 205, 600, 20))
        ...
        if objects.values["add_key"]:
            objects.values["keys"] += 1
            objects.values["add_key"] = False

        if objects.values["keys"] == 6:
        ...
        if objects.values["tutorial_timer"] < 160:
            display.blit(pygame.image.load("assets/textures/intro/space_station_0.png"), [0, 0])
        elif objects.values["tutorial_timer"] < 360:
            display.blit(pygame.image.load("assets/textures/intro/space_station_1.png"), [0, 0])
        elif objects.values["tutorial_timer"] < 400:
