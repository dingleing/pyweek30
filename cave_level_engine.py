...
class Timers:
    ...
    @staticmethod
    def rise_lava(objects):
        objects.values["lava_level"] += 1
    ...
    def add_timer(self, duration, repeat, type_of_timer):
        ...
        elif type_of_timer == "lava_rise":
            self.timers.append([Timer(duration, repeat, [], type_of_timer), self.rise_lava])
